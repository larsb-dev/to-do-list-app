<aside
  class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 border-gray-200">
  {{-- <a href="#">--}}
  ...
  <div class="flex flex-col justify-between flex-1 mt-6">
    ...
    <div class="flex items-center justify-between mt-6">
      <span
        class="text-sm font-medium text-gray-700 dark:text-gray-200">{{ Auth::user()->name ?? 'Default User' }}</span>
